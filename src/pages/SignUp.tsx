      ...
      >
        <div className="glass-card rounded-3xl p-8 md:p-10 shadow-2xl border border-white/10">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400">Join the future of campus dining</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link to="/login" className="text-white font-medium hover:underline decoration-white/50 underline-offset-4 transition-all">
                Sign In
              </Link>
            </p>
          </div>
